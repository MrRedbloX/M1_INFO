...
public class PageRankMR {
  ...
  public static void main(String[] args) {
    ...
    if ((args == null) || args.length==0){
      args = new String[] { 
        //"frwiki-links-100-articles",     //  loop 3 : pagerank average= 0.15388  
        //"frwiki-ranks-100-articles",
        "frwiki-links-1000-articles",   // loop 3 : pagerank average= 0.156449
        "frwiki-ranks-1000-articles", 
        //"frwiki-links-10000-articles", // loop 4 : pagerank average= 0.1829261 
        //"frwiki-ranks-10000-articles", 
        //"frwiki-links-100000-articles", // loop 5 : pagerank average= 0.21256295
        //"frwiki-ranks-100000-articles", 
        //"frwiki-links-articles",    // loop ? : pagerank average= ????????
