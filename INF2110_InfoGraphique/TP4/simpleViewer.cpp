...
void Viewer::keyPressEvent(QKeyEvent *e) {
  ...
  if ((e->key() == Qt::Key_T) && (modifiers == Qt::NoButton)) {
    ...
    handled = true;
      ...
      qreal D1 = sqrt((p2.z*p2.z)+(p2.x*p2.x));
      qreal xn2 = (p2.x*p2.z/D1) - (p2.z*p2.x/D1);
      qreal zn2 = (p2.x*p2.x/D1) - (p2.z*p2.z/D1);
      qreal xn3 = (p3.x*p2.z/D1) - (p3.z*p2.x/D1);
      qreal zn3 = (p3.x*p2.x/D1) - (p3.z*p2.z/D1);
      p2.x = xn2;
      p2.z = zn2;
      p3.x = xn3;
      p3.z = zn3;
